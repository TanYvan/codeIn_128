class OrgAppraisalController < ApplicationController
  def p_set
    if params[:p_typ]=='0001'
      ...
      org=TbPeriod.find_by_sql("select tb_expertconsults.code as code,tb_expertconsults.name as name from tb_periods,tb_expertconsults where tb_expertconsults.used='Y' and tb_periods.code=tb_expertconsults.code  order by tb_expertconsults.code")
    end
