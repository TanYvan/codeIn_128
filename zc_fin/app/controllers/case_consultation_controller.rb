class CaseConsultationController < ApplicationController
  ...
  def list
    ...
    @hant_search_1=[['char','recevice_code','咨询流水号','text',[]],['date','receivedate','咨询日期','text',[]],['number','amount','争议金额','text',[]],['char','recevice_code ) in (select recevice_code  from  tb_parties where partyname','当事人名称','text',[]]]
    @order=params[:order]
