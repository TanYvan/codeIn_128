class AmountTotalController < ApplicationController
  def list
    ...
    @hant_search_1_list=['(CASE caseendbook_id_first is null WHEN true  THEN  0 ELSE 1 END)']
    @hant_search_1_word=params[:hant_search_1_word]
    @hant_search_1_text=params[:hant_search_1_text]
    if @hant_search_1_word==nil
      @hant_search_1_word="(CASE caseendbook_id_first is null WHEN true  THEN  0 ELSE 1 END) = 0 "
      @hant_search_1_text="是否结案 等于 否 "
    else
