...
class DisposalController < ApplicationController
  ...
  def disposal_delete
    ...
    @disposal.u=session[:user_code]
    @disposal.u_t=Time.now()
#    TbCaseFlow.del_flow(@disposal.recevice_code,'0001')
    if @disposal.save
      flash[:notice]="删除成功"
    else
      flash[:notice]="删除失败"
  ...
  def p_s
    ...
    if @case.special_convention=="0001" || @case.special_convention.blank?
      if @case.aribitprog_num=='0001' or @case.aribitprog_num=='0003' or @case.aribitprog_num=='0005' or @case.aribitprog_num=='0007'
         @easy=false
       else
         @easy=true
       end
    ...
    if !@easy #@aribitprog_num=='0001' or @aribitprog_num=='0003' or @aribitprog_num=='0005' or @aribitprog_num=='0007'
