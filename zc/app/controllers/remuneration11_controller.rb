# 新的仲裁员报酬  助理录入裁决书制作信息、绩效信息，由处长对此做评级，评级的同时自动计算相应的报酬。
# 录入或者删除裁决书制作信息和绩效信息的同时需要修改 tb_bonus_penalties 对应的记录

class Remuneration11Controller < ApplicationController
