class Doc_format
  ...
  def format_letter_fmt03(code,doc_id)
    ...
    @case= TbCase.find(:first,:conditions=>["used='Y' and recevice_code=?",code])
    @r1 = @case.case_code
    @format_fmt03 = add_record("<01$$$>",@r1,@format_fmt03)
    @r2 = @case.aribitprog_num
    @resp = TbDoc.find(:first,:conditions=>["used='Y' and recevice_code=? and typ_code='001202'",code],:order=>"id desc")
    if @resp!=nil
      arr_date = @resp.ss_t.to_s.split("-")
    ...
    if @r2=='0001'
      ...
      @resp = TbDoc.find(:first,:conditions=>["used='Y' and recevice_code=? and typ_code='0011'",code],:order=>"id desc")
      if @resp!=nil
        arr_date = @resp.ss_t.to_s.split("-")
        arr_date[1]=arr_date[1].to_i.to_s
        arr_date[2]=arr_date[2].to_i.to_s
      ...
      @resp = TbDoc.find(:first,:conditions=>["used='Y' and recevice_code=? and typ_code='0009'",code],:order=>"id desc")
      if @resp!=nil
        arr_date = @resp.ss_t.to_s.split("-")
        arr_date[1]=arr_date[1].to_i.to_s
        arr_date[2]=arr_date[2].to_i.to_s
      ...
      @format_fmt03 = add_record("<03$$$>","普通",@format_fmt03)
      @resp = TbDoc.find(:first,:conditions=>["used='Y' and recevice_code=? and typ_code='0012'",code],:order=>"id desc")
      if @resp!=nil
        arr_date = @resp.ss_t.to_s.split("-")
        arr_date[1]=arr_date[1].to_i.to_s
        arr_date[2]=arr_date[2].to_i.to_s
      ...
      @format_fmt03 = add_record("<02$$$>","涉外",@format_fmt03)
      @format_fmt03 = add_record("<03$$$>","简易",@format_fmt03)
      @resp = TbDoc.find(:first,:conditions=>["used='Y' and recevice_code=? and typ_code='0010'",code],:order=>"id desc")
      if @resp!=nil
        arr_date = @resp.ss_t.to_s.split("-")
        arr_date[1]=arr_date[1].to_i.to_s
        arr_date[2]=arr_date[2].to_i.to_s
    ...
    if @case.accepttime!=nil
      arr_date = @case.accepttime.to_s.split("-")
      arr_date[1]=arr_date[1].to_i.to_s
      arr_date[2]=arr_date[2].to_i.to_s
      @r4=arr_date[0].to_i.to_s+"年"+arr_date[1]+"月"+arr_date[2]+"日"
    else
      @r4="______年___月___日"
    end
    @format_fmt03 = add_record("<04$$$>",@r4,@format_fmt03)
    @ccc=TbShouldCharge.count(:conditions=>"used='Y' and recevice_code='#{code}'")
    @s=TbShouldCharge.find(:first,:select=>"sum(rmb_money-re_rmb_money-redu_rmb_money) as s1",:conditions=>["used = 'Y' and recevice_code=? and (typ='0001' or typ='0004')",code])
    if @s!=nil
      @sss=@s.s1.to_i
    else
      @sss=0
    ...
    #财产保全(申请人，被申请人)-----------------------------
    @save1=TbSave.find(:first,:conditions=>["used='Y' and recevice_code=? and request_typ=? and typed=?",code,'0001','0002'])
    if @save1!=nil
      @send_time1=@save1.send_time
      arr_date = @send_time1.to_s.split("-")
      arr_date[1]=arr_date[1].to_i.to_s
      arr_date[2]=arr_date[2].to_i.to_s
      send_time1="申请人"+@save1.request_man+"于"+arr_date[0].to_i.to_s+"年"+arr_date[1]+"月"+arr_date[2]+"日提出财产保全申请"
    else
      send_time1="申请人/被申请人于_____年___月__日提出财产保全申请"
    end
    @save2=TbSave.find(:first,:conditions=>["used='Y' and recevice_code=? and request_typ=? and typed=?",code,'0002','0002'])
    if @save2!=nil
      @send_time2=@save2.send_time
      arr_date = @send_time2.to_s.split("-")
      arr_date[1]=arr_date[1].to_i.to_s
      arr_date[2]=arr_date[2].to_i.to_s
      if send_time1!=""
        send_time2="，被申请人"+@save2.request_man+"于"+arr_date[0].to_i.to_s+"年"+arr_date[1]+"月"+arr_date[2]+"日提出财产保全申请"
      else
        send_time2="被申请人"+@save2.request_man+"于"+arr_date[0].to_i.to_s+"年"+arr_date[1]+"月"+arr_date[2]+"日提出财产保全申请"
      end
    else
    ...
    #证据保全(申请人，被申请人)--------------------------------------------
    @save11=TbSave.find(:first,:conditions=>["used='Y' and recevice_code=? and request_typ=? and typed=?",code,'0001','0001'])
    if @save11!=nil
      @send_time11=@save11.send_time
      arr_date = @send_time11.to_s.split("-")
      arr_date[1]=arr_date[1].to_i.to_s
      arr_date[2]=arr_date[2].to_i.to_s
      send_time11="申请人"+@save11.request_man+"于"+arr_date[0].to_i.to_s+"年"+arr_date[1]+"月"+arr_date[2]+"日提出证据保全申请"
    else
      send_time11="申请人/被申请人于_____年___月__日提出证据保全申请"
    end
    @save22=TbSave.find(:first,:conditions=>["used='Y' and recevice_code=? and request_typ=? and typed=?",code,'0002','0001'])
    if @save22!=nil
      @send_time22=@save22.send_time
      arr_date = @send_time22.to_s.split("-")
      arr_date[1]=arr_date[1].to_i.to_s
      arr_date[2]=arr_date[2].to_i.to_s
      if send_time11!=""
        send_time22="，被申请人"+@save22.request_man+"于"+arr_date[0].to_i.to_s+"年"+arr_date[1]+"月"+arr_date[2]+"日提出证据保全申请"
      else
        send_time22="被申请人"+@save22.request_man+"于"+arr_date[0].to_i.to_s+"年"+arr_date[1]+"月"+arr_date[2]+"日提出证据保全申请"
      end
    else
    ...
    str8=send_time11+send_time22
    @format_fmt03 = add_record("<08$$$>",str8,@format_fmt03)
    #被申请人于    年    月    日提出管辖权异议。仲裁委员会于       年     月    日作出决定
    @jurisdiction=TbJurisdiction.find(:first,:conditions=>["used='Y' and recevice_code=? and submitman='0002'",code])
    if @jurisdiction!=nil
      arr_date = @jurisdiction.request_date.to_s.split("-")
      arr_date[1]=arr_date[1].to_i.to_s
      arr_date[2]=arr_date[2].to_i.to_s
      arr_date2 = @jurisdiction.decide_date.to_s.split("-")
      arr_date2[1]=arr_date2[1].to_i.to_s
      arr_date2[2]=arr_date2[2].to_i.to_s
      str9="被申请人"+@jurisdiction.request_man+"于"+arr_date[0].to_i.to_s+"年"+arr_date[1]+"月"+arr_date[2]+"日提出管辖权异议。仲裁委员会于"+arr_date2[0].to_i.to_s+"年"+arr_date2[1]+"月"+arr_date2[2]+"日作出决定"
    else
    ...
    if @requ!=nil
      ...
      arr_date[1]=arr_date[1].to_i.to_s
      arr_date[2]=arr_date[2].to_i.to_s
      str101='\r    '+"4、被申请人"+"于"+arr_date[0].to_i.to_s+"年"+arr_date[1]+"月"+arr_date[2]+"日提交了答辩"
    else
      str101=""
    end
    ...
    if @ans!=nil
      ...
      arr_date2[2]=arr_date2[2].to_i.to_s
      if str101!=""
        str102="，于"+arr_date2[0].to_i.to_s+"年"+arr_date2[1]+"月"+arr_date2[2]+"日提交了反请求。"
      else
        str102='\r    '+"4、被申请人于"+arr_date2[0].to_i.to_s+"年"+arr_date2[1]+"月"+arr_date2[2]+"日提交了反请求。"
      end
    else
      str102=""
    end
    ...
    if str10!=""
      ...
      if PubTool.new.get_first_record(@adjudgebrike)!=nil
        for s in @adjudgebrike
          str_19=TbDictionary.find(:first,:conditions=>["typ_code='8106' and state='Y' and used='Y' and data_val=?",s.requestman_type]).data_text
      ...
      @format_fmt03 = add_record("<16$$$>",4,@format_fmt03)
      @format_fmt03 = add_record("<17$$$>",5,@format_fmt03)
      if PubTool.new.get_first_record(@adjudgebrike)!=nil
        for s in @adjudgebrike
          str_19=TbDictionary.find(:first,:conditions=>["typ_code='8106' and state='Y' and used='Y' and data_val=?",s.requestman_type]).data_text
          end_date = s.end_date.to_s.split("-")
      ...
      if str19!=""
        @format_fmt03 = add_record("<18$$$>","6、",@format_fmt03)
      else
        @format_fmt03 = add_record("<18$$$>","",@format_fmt03)
      end
    end
    @format_fmt03 = add_record("<19$$$>",str19,@format_fmt03)
    if @r2=='0002' or @r2=='0004' or @r2=='0006' or @r2=='0008'
      str11="仲裁庭组成情况：由仲裁委员会主任指定"+PubTool.arbitrator(code,'0001') + get_arbitman_sex(code,'0001') +"担任独任仲裁员"
    else
      @a=TbCasearbitman.find(:first,:conditions=>["used='Y' and recevice_code=? and arbitmantype=?",code,'0003'])
      if @a!=nil
        if @a.arbitmansign!='0005'
          ...
          stra="仲裁委员会主任代申请人指定"+PubTool.arbitrator(code,'0003')+ get_arbitman_sex(code,'0003')+"作为本案仲裁员"
        end
      else
        stra="申请人选定_____作为本案仲裁员"
      end
      #被申请人的仲裁员
      @b=TbCasearbitman.find(:first,:conditions=>["used='Y' and recevice_code=? and arbitmantype=?",code,'0004'])
      if @b!=nil
        if @b.arbitmansign!='0005'
          ...
          strb="，仲裁委员会主任代被申请人指定"+PubTool.arbitrator(code,'0004')+ get_arbitman_sex(code,'0004')+"作为本案仲裁员"
        end
      else
        strb="，被申请人选定_____作为本案仲裁员"
      end
      str11="仲裁庭组成情况："+ stra + strb +"，由仲裁委员会主任指定"+PubTool.arbitrator(code,'0002')+ get_arbitman_sex(code,'0002')+"担任首席仲裁员"
    end
    change=""
    @change=TbChange.find(:all,:conditions=>["used='Y' and recevice_code=?",code])
    for ch in @change
      if ch!=nil
    ...
    if @case_date != nil or @case_date == ""
      ...
      end_date1=end_date[1].to_i.to_s+"月"
      end_date2=end_date[2].to_i.to_s+"日"
      @org_date="仲裁庭于"+end_date10+end_date1+end_date2+"组成"
    else
    ...
    if @sittingdate!=nil
      ...
      arr_date[1]=arr_date[1].to_i.to_s
      arr_date[2]=arr_date[2].to_i.to_s
      @sdate="，定于"+arr_date[0].to_i.to_s+"年"+arr_date[1]+"月"+arr_date[2]+"日开庭"
    else
      @sdate="，定于____年__月__日开庭"
    end
    str12=@org_date + @sdate
    @format_fmt03 = add_record("<12$$$>",str12,@format_fmt03)
    #申请人/被申请人于  年 月 日提出仲裁员回避申请。仲裁委员会主任于  年 月 日作出决定
    ...
    if @evite!=nil
      if @evite.requestdate!=nil
        ...
        arr_date[0]=arr_date[0].to_i.to_s
        arr_date[1]=arr_date[1].to_i.to_s
        arr_date[2]=arr_date[2].to_i.to_s
        d1=arr_date[0]+"年"+arr_date[1]+"月"+arr_date[2]+"日"
      else
        d1="____年__月__日"
      end
      if @evite.dat3!=nil
        arr_date2 = @evite.dat3.to_s.split("-")
        arr_date2[0]=arr_date2[0].to_i.to_s
        arr_date2[1]=arr_date2[1].to_i.to_s
        arr_date2[2]=arr_date2[2].to_i.to_s
        d2="仲裁委员会主任于"+arr_date2[0]+"年"+arr_date2[1]+"月"+arr_date2[2]+"日作出决定"
      else
        d2="仲裁委员会主任尚未作出决定"
      end
      ...
      str13="申请人/被申请人于_____年___月___日提出仲裁员回避申请。仲裁委员会主任于_____年___月___日作出决定"
    end
  ...
  def format_letter_fmt11a(code,doc_id)
    ...
    if @style1=="代指定"
      if @n1>1
        @seven = "因申请人未在规定的期限内共同选定或共同委托仲裁委员会主任指定仲裁员而由仲裁委员会主任为申请人指定仲裁员"+@b+get_arbitman_sex(code,'0003')
      else
        @seven = "因申请人未在规定的期限内选定或委托仲裁委员会主任指定仲裁员而由仲裁委员会主任为申请人指定仲裁员"+@b+get_arbitman_sex(code,'0003')
      end
    else
    ...
    if @style2=="代指定"
      if @n2>1
        @eight = "因被申请人未在规定的期限内共同选定或共同委托仲裁委员会主任指定仲裁员而由仲裁委员会主任为被申请人指定仲裁员"+@c+get_arbitman_sex(code,'0004')
      else
        @eight = "因被申请人未在规定的期限内选定或委托仲裁委员会主任指定仲裁员而由仲裁委员会主任为被申请人指定仲裁员"+@c+get_arbitman_sex(code,'0004')
      end
    else
      @eight = "被申请人"+@style2+@c+get_arbitman_sex(code,'0004')+"作为本案仲裁员"
    end
    if @style3=="代指定"
      @nine = "因双方未在规定的期限内共同选定或共同委托仲裁委员会主任指定首席仲裁员而由仲裁委员会主任指定"+chief_arbitrator(code) + get_arbitman_sex(code,'0002')+"作为本案首席仲裁员"
    else
  ...
  def format_letter_fmt17a(code,doc_id)
    ...
    if @style3=="代指定"
      @nine = "因双方未在规定的期限内共同选定或共同委托仲裁委员会主任指定独任仲裁员而由仲裁委员会主任指定" + independent_arbitrator(code) + get_arbitman_sex(code,'0001')+"作为本案独任仲裁员"
    else
    ...
    #独任仲裁员
    c1 = independent_arbitrator(code)
  ...
  def format_letter_fmt17(code,doc_id)
    ...
    if @style1=="委托"
      ...
      @style1="共同委托仲裁委员会主任指定"
    end
    @independent_arbitrator = independent_arbitrator(code)+ get_arbitman_sex(code,'0001')
    if @style1=="代指定"
      @independent_arbitrator1="因双方未在规定的期限内共同选定/共同委托指定独任仲裁员，中国国际经济贸易仲裁委员会主任指定" + @independent_arbitrator +"作为本案独任仲裁员"
    else
  ...
  def format_letter_fmt18(code,p_v,doc_id)
    ...
    if p_v=='0001'  #申请人
      ...
      @recevicedate11=get_recevicedate1(code)
      @materialtype11=get_materialtype1(code)
      @recevicedate2=get_recevicedate2(code)
      @materialtype2=get_materialtype2(code)
      @str8="申请人附去我会秘书处于" + @recevicedate11 + "收到的" + get_third_party(code,'0001') + "提交的" + @materialtype11 + "一式一份" +
        "，向被申请人附去我会秘书处于" + @recevicedate2 + "收到的" + get_third_party(code,'0002') + "提交的" + @materialtype2 + "一式一份"
    end
  ...
  def format_letter_fmt23b(code,p_v,ar_nu)
    ...
    if p_v=='0006'
      ...
      @rep11 = "首席仲裁员"
      #    else
      #      @replace6="申请人的选定/被申请人的选定/仲裁委员会主任的指定"
      #      @replace7="选定/指定"
      #      @replace8="选定/指定"
      #      @replace9="选定/指定"
      #      @rep10 = "首席仲裁员"
  ...
  def format_letter_fmt23m(code,ar_nu)
    ...
    @replace6="仲裁委员会主任的"+@independent_arbitrator
  ...
  def format_letter_fmt38a(code,doc_id,ar_nu)
    ...
    if @style2=="委托"
      ...
      @style2="共同委托仲裁委员会主任指定"
    end
    if @style3=="委托"
      @style3="委托仲裁委员会主任指定"
    elsif @style3=="共同委托"
      @style3="共同委托仲裁委员会主任指定"
    end
    if @style4=="委托"
      @style4="委托仲裁委员会主任指定"
    elsif @style4=="共同委托"
      @style4="共同委托仲裁委员会主任指定"
    end
    ...
    if @aribitprog_num=='0001' or @aribitprog_num=='0003' or @aribitprog_num=='0005'  or @aribitprog_num=='0007'#普通
      ...
      if @style1=="代指定"
        if @n1>1
          @seven = "由于申请人未在规定的期限内共同选定或共同委托仲裁委员会主任指定仲裁员，仲裁委员会主任为申请人指定"+@b+get_arbitman_sex(code,'0003')+"担任本案仲裁员"
        else
          @seven = "由于申请人未在规定的期限内选定或委托仲裁委员会主任指定仲裁员，仲裁委员会主任为申请人指定"+@b+get_arbitman_sex(code,'0003')+"担任本案仲裁员"
        end
      else
      ...
      if @style2=="代指定"
        if @n2>1
          @eight = "，由于被申请人未在规定的期限内共同选定或共同委托仲裁委员会主任指定仲裁员，仲裁委员会主任为被申请人指定"+@c+get_arbitman_sex(code,'0004')+"担任本案仲裁员"
        else
          @eight = "，由于被申请人未在规定的期限内选定或委托仲裁委员会主任指定仲裁员，仲裁委员会主任为被申请人指定"+@c+get_arbitman_sex(code,'0004')+"担任本案仲裁员"
        end
      else
        @eight = "，被申请人"+@style2+@c+get_arbitman_sex(code,'0004')+"担任本案仲裁员"
      end
      if @style3=="代指定"
        @nine = "。由于双方未共同选定或共同委托仲裁委员会主任指定首席仲裁员，仲裁委员会主任指定"+chief_arbitrator(code) + get_arbitman_sex(code,'0002')+"担任本案首席仲裁员"
      else
      ...
      if @style4=="代指定"#未选定独任仲裁员
        @eight="由于双方未共同选定或共同委托仲裁委员会主任指定独任仲裁员，仲裁委员会主任指定您担任独任仲裁员"
        @replace28 = "指定"
        @rep31 = "指定"
      else
  ...
  def format_letter_fmt39(code,doc_id,ar_nu)
    ...
    if ar_nu=='0001'#国内案件
      if @aribitprog_num=='0001' #国内普通
        @legal_code="四条第（一）款、第六十五"
      else
        @legal_code="四条第（一）款、第五十六"
      end
      rep15 = ""
      rep16 = ""
    elsif ar_nu=='0002'#涉外案件
      if @aribitprog_num=='0003'
        @legal_code="四条第（一）款、第四十二"
      else
        @legal_code="四条第（一）款、第五十六"
      end
      rep15 = ""
  ...
  def format_letter_fmt40(code,doc_id)
    ...
    if @case_code1=='0001' or @case_code1=='0003' or @case_code1=='0005' #普通
      if @style1!="f" && @style2!="f" && @style3=="f" #首席未选定
        @arbitrator19 = "鉴于申请人和被申请人未能按期共同选定或共同委托仲裁委员会主任指定首席仲裁员"
        @arbitrator20 = "首席仲裁员"
        @replace22 = "基于上述情况，我分会秘书处拟请仲裁委员会主任为双方指定_____先生/女士为本案首席仲裁员。"
      elsif @style1=="f" && @style2!="f" && @style3!="f" #申请人未选定
        if @n1>1
          @arbitrator19 = "鉴于申请人未能按期共同选定或共同委托仲裁委员会主任指定仲裁员"
        else
          @arbitrator19 = "鉴于申请人未能按期选定或委托仲裁委员会主任指定仲裁员"
        end
        @arbitrator20 = "仲裁员"
        @replace22 = "基于上述情况，我分会秘书处拟请仲裁委员会主任为申请人指定_____先生/女士为本案仲裁员。"
      elsif @style1!="f" && @style2=="f" && @style3!="f" #被申请人未选定
        if @n2>1
          @arbitrator19 = "鉴于被申请人未能按期共同选定或共同委托仲裁委员会主任指定仲裁员"
        else
          @arbitrator19 = "鉴于被申请人未能按期选定或委托仲裁委员会主任指定仲裁员"
        end
        @arbitrator20 = "仲裁员"
        @replace22 = "基于上述情况，我分会秘书处拟请仲裁委员会主任为被申请人指定_____先生/女士为本案仲裁员。"
      elsif  @style1=="f" && @style2=="f" && @style3!="f" #申请人和被申请人未选定仲裁员
        if @n1>1
          @arbitratora = "鉴于申请人未能按期共同选定或共同委托仲裁委员会主任指定仲裁员,"
        else
          @arbitratora = "鉴于申请人未能按期选定或委托仲裁委员会主任指定仲裁员,"
        end
        if @n2>1
          @arbitratorb = "被申请人未能按期共同选定或共同委托仲裁委员会主任指定仲裁员"
        else
          @arbitratorb = "被申请人未能按期选定或委托仲裁委员会主任指定仲裁员"
        end
        @arbitrator19 = @arbitratora + @arbitratorb
        @arbitrator20 = "仲裁员"
        @replace22 = "基于上述情况，我分会秘书处拟请仲裁委员会主任为申请人指定_____先生/女士为本案仲裁员,为被申请人指定_____先生/女士为本案仲裁员。"
      elsif @style1=="f" && @style2!="f" && @style3=="f" #申请人、双方未选定
        if @n1>1
          @arbitrator19 = "鉴于申请人未能按期共同选定或共同委托仲裁委员会主任指定仲裁员,申请人和被申请人未能按期共同选定或共同委托仲裁委员会主任指定首席仲裁员"
        else
          @arbitrator19 = "鉴于申请人未能按期选定或委托仲裁委员会主任指定仲裁员,申请人和被申请人未能按期共同选定或共同委托仲裁委员会主任指定首席仲裁员"
        end
        @arbitrator20 = "仲裁员/首席仲裁员"
        @replace22 = "基于上述情况，我分会秘书处拟请仲裁委员会主任为申请人指定_____先生/女士为本案仲裁员,为双方指定_____先生/女士为本案首席仲裁员。"
      elsif @style1!="f" && @style2=="f" && @style3=="f" #被申请人、双方未选定
        if @n2>1
          @arbitrator19 = "鉴于被申请人未能按期共同选定或共同委托仲裁委员会主任指定仲裁员,申请人和被申请人未能按期共同选定或共同委托仲裁委员会主任指定首席仲裁员"
        else
          @arbitrator19 = "鉴于被申请人未能按期选定或委托仲裁委员会主任指定仲裁员,申请人和被申请人未能按期共同选定或共同委托仲裁委员会主任指定首席仲裁员"
        end
        @arbitrator20 = "仲裁员/首席仲裁员"
        @replace22 = "基于上述情况，我分会秘书处拟请仲裁委员会主任为被申请人指定_____先生/女士为本案仲裁员,为双方指定_____先生/女士为本案首席仲裁员。"
        ...
        @arbitrator19 = @arbitratora + @arbitratorb + "申请人和被申请人未能按期共同选定或共同委托仲裁委员会主任指定首席仲裁员"
        @arbitrator20 = "仲裁员/首席仲裁员"
        @replace22 = "基于上述情况，我分会秘书处拟请仲裁委员会主任为申请人指定_____先生/女士为本案仲裁员,为被申请人指定_____先生/女士为本案仲裁员,为双方指定_____先生/女士为本案首席仲裁员。"
      else #都选定了
        if @style1!="代指定"
          @seven="申请人" + @style1 + applicant_arbitrator(code) + get_arbitman_sex(code,'0003') + "担任本案仲裁员"
        else
          @seven="仲裁委员会主任为申请人指定" + applicant_arbitrator(code) + get_arbitman_sex(code,'0003') + "担任本案仲裁员"
        end
        if @style2!="代指定"
          @eight="，被申请人" + @style2 + respondent_arbitrator(code) + get_arbitman_sex(code,'0004') + "担任本案仲裁员"
        else
          @seven="，仲裁委员会主任为被申请人指定" + respondent_arbitrator(code) + get_arbitman_sex(code,'0003') + "担任本案仲裁员"
        end
        if @style3!="代指定"
          @nine="，双方" + @style3 + chief_arbitrator(code) + get_arbitman_sex(code,'0002') + "担任本案首席仲裁员"
        else
          @nine="，仲裁委员会主任为双方指定" + @style3 + chief_arbitrator(code) + get_arbitman_sex(code,'0002') + "担任本案首席仲裁员"
        end
      ...
      if @style4=="f"#未选定独任仲裁员
        @arbitrator19="鉴于双方未能按期共同选定或共同委托仲裁委员会主任指定独任仲裁员"
        @replace22="基于上述情况，我分会秘书处拟请仲裁委员会主任为双方指定_____先生/女士为本案独任仲裁员。"
      else
      ...
      if @arbitmansign!=nil
        if @arbitmansign=='0005' #代指定
          if @aribitprog_num=='0002' or @aribitprog_num=='0004' or @aribitprog_num=='0006' or @aribitprog_num=='0008'#简易
            @aaa="由于双方未共同选定或共同委托仲裁委员会主任指定" + @a + "，仲裁委员会主任指定"
          else
            @aaa="指定"
          end
        else
  ...
  #2.接收人为被申请人:日期、收文材料
  def get_recevicedate2(code)
    @amail2=TbAmail.find(:first,:conditions=>["used='Y' and recevice_code=? and submitman='0001'",code],:order=>"id desc")
    if @amail2!=nil
  ...
  #提交人：当事人 或第三方
  def get_third_party(code,p1)
    if p1=='0001'#申请人,显示被申请人
      @amail1=TbAmail.find(:first,:conditions=>["used='Y' and recevice_code=? and  submitman='0002'",code],:order=>"id desc")
      if @amail1!=nil
        if @amail1.arbitman!=nil and @amail1.arbitman!=""
          return "被申请人" + @amail1.arbitman
        else
          return "被申请人"
        end
      else
      ...
      @amail2=TbAmail.find(:first,:conditions=>["used='Y' and recevice_code=? and submitman='0001'",code],:order=>"id desc")
      if @amail2!=nil
        if @amail2.arbitman!=nil and @amail2.arbitman!=""
          return "申请人" + @amail2.arbitman
        else
          return "申请人"
        end
      else
